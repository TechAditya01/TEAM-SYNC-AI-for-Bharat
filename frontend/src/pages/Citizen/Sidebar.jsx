...
const Sidebar = ({ isOpen }) => {
    ...
    return (
        <>
            ...
            <aside className={`hidden md:flex bg-white dark:bg-slate-800 border-r border-slate-200 dark:border-slate-700 flex-col transition-all duration-300 z-30 ${isOpen ? 'w-64' : 'w-20'}`}>
                {/* Logo Section */}
