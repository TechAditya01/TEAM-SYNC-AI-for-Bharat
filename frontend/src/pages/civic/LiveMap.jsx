...
import { getDatabase, ref, onValue } from '../../services/localDatabase';
import { auth } from '../../services/authService';
import { GoogleMap, useJsApiLoader, Marker, OverlayView } from '../../services/mapAdapter';
...
const LiveMap = () => {
    ...
    const { isLoaded } = useJsApiLoader({ id: 'map-script', libraries });
