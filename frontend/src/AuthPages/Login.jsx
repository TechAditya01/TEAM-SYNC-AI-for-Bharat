                ...
                <div className="hidden lg:flex w-1/2 relative flex-col justify-start pt-32 px-12 pb-12 text-slate-800 dark:text-white bg-slate-50 dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 transition-colors">
                    ...
                    <div className="relative z-10 mb-8">
                        ...
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-100/50 dark:bg-white/10 backdrop-blur-md border border-blue-200 dark:border-white/20 text-blue-800 dark:text-white text-xs font-medium mb-6">
                            ...
                            {t('authSecureOfficialPortal')}
                        </div>
                        <h1 className="text-5xl font-bold leading-tight mb-4 text-slate-900 dark:text-white">
                            {t('authLoginHeadingLine1')}<br />
                            <span className="text-blue-600 dark:text-blue-400">{t('authLoginHeadingLine2')}</span>
                        </h1>
                        ...
                        <div className="flex items-center gap-4">
                            <div className="flex items-center gap-3 px-4 py-3 rounded-lg bg-white/80 dark:bg-white/5 backdrop-blur-sm border border-slate-200 dark:border-white/10 shadow-sm dark:shadow-none">
                                ...
                                <div>
                                    <div className="text-[10px] text-slate-500 dark:text-gray-400 uppercase tracking-wider">{t('authVerified')}</div>
                                    <div className="text-sm font-semibold text-slate-900 dark:text-white">{t('authGovPlatform')}</div>
                                </div>
                            </div>
                            <div className="flex items-center gap-3 px-4 py-3 rounded-lg bg-white/80 dark:bg-white/5 backdrop-blur-sm border border-slate-200 dark:border-white/10 shadow-sm dark:shadow-none">
                                ...
                                <div>
                                    <div className="text-[10px] text-slate-500 dark:text-gray-400 uppercase tracking-wider">{t('authSecurity')}</div>
                                    <div className="text-sm font-semibold text-slate-900 dark:text-white">{t('authEncryption')}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="w-full lg:w-1/2 flex flex-col relative px-6 py-12 lg:p-24 justify-center bg-white dark:bg-[#0f172a] transition-colors">
                    <div className="max-w-110 w-full mx-auto">
                        <div className="text-center mb-10">
                            ...
                            <p className="text-slate-500 dark:text-gray-400 text-sm">{t('authSecureAccessTagline')}</p>
                        </div>
                        ...
                        <form className="space-y-6" onSubmit={handleLogin}>
                            <div className="space-y-2">
                                <label className="text-xs font-semibold text-slate-500 dark:text-gray-400 uppercase tracking-wider">
                                    {userType === 'citizen' ? t('authEmailAddress') : t('authOfficialIdEmail')}
                                </label>
                                <div className="relative">
                                    ...
                                    <input
                                        type="email"
                                        placeholder={userType === 'citizen' ? t('authEmailPlaceholder') : t('authOfficialEmailPlaceholder')}
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-semibold text-slate-500 dark:text-gray-400 uppercase tracking-wider">{t('authPassword')}</label>
                                <div className="relative">
                                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400 dark:text-gray-500">
                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
                                    </div>
                            ...
                            <div className="flex justify-end mt-1">
                                <Link to="/forgot-password" className="text-sm text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 transition-colors">{t('authForgotPassword')}</Link>
                            </div>
